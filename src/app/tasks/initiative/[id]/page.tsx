    ...
    return (
      <main className="min-h-screen bg-white dark:bg-gray-950 px-4 py-12">
        <div className="max-w-3xl mx-auto text-center py-24">
          ...
          <Link href="/tasks" className="text-sm text-emerald-600 dark:text-emerald-400 hover:underline">
            &larr; {t('backToBoard')}
          </Link>
        </div>
      </main>
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-gray-950 px-4 py-12">
      <div className="max-w-3xl mx-auto">
        <div className="mb-4">
          <Link href="/tasks" className="text-xs text-emerald-600 dark:text-emerald-400 hover:underline">
            &larr; {t('board')}
          </Link>
        </div>
