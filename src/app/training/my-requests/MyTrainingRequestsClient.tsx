...
import { withdrawTrainingRequestAction } from '@/app/actions/training';
...
export function MyTrainingRequestsClient({ requests }: Readonly<{ requests: Request[] }>) {
          ...
          {requests.map((r) => (
            <RequestCard
              ...
              fields={[
                ...
                { label: t('myRequests.skillGapLabel'), value: r.skillGapDescription },
                { label: t('myRequests.formatLabel'), value: r.formatPreference },
                { label: t('myRequests.levelLabel'), value: r.levelPreference },
              ]}
              createdAt={r.createdAt}
              actions={
                <LifecycleActionButton
                  action={() => withdrawTrainingRequestAction(r.id)}
                  tone="danger"
                  labels={{
